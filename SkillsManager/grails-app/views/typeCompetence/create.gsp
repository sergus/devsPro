...
<html>
	...
	<body>
		<a href="#create-typeCompetence" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-typeCompetence" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
				<fieldset class="form">
					<f:all bean="typeCompetenceInstance"/>
				</fieldset>
